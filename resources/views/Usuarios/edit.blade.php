<x-app-layout>  
    ...
    <div class="form-edit">
        <form method="post" action="{{ route('usuarios.update', $usuarios->id) }}">
            ...
            @method('PUT')
            <h1>Nome</h1>
            <input type="text" name="name" id="name" placeholder="Nome" value="{{$usuarios->name}}"> <br>
            <h1>E-mail</h1>
            <input type="text" name="email" id="email" placeholder="E-mail" value="{{$usuarios->email}}"> <br>
            <h1>Senha</h1>
            <input type="password" name="password" id="password" placeholder="Senha" value="{{$usuarios->password}}"> <br>
            <h1>Telefone</h1>
            <input type="text" name="telefone" id="telefone" placeholder="Telefone" value="{{$usuarios->telefone}}"> <br>
            <h1>Técnico?</h1>
